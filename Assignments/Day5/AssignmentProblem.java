...
public class AssignmentProblem {
    public static void main(String[] args) {
        ...
        employees.add(new Employee("Rohit", "Verma", LocalDate.of(1998, 10, 5), 75000, "HR", LocalDate.of(2022, 4, 18)));
        employees.add(new Employee("Priya", "Singh", LocalDate.of(2002, 6, 22), 62000, "Marketing", LocalDate.of(2024, 2, 9)));
        employees.add(new Employee("Arjun", "Yadav", LocalDate.of(1995, 11, 3), 80000, "Operations", LocalDate.of(2025, 1, 1)));
        employees.add(new Employee("Meera", "Patel", LocalDate.of(1999, 9, 30), 70000, "Design", LocalDate.of(2023, 8, 21)));
